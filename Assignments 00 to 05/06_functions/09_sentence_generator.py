# Problem Statement
# Implement the helper function make_sentence(word, part_of_speech) which will take 
# a string word and an integer part_of_speech as parameters and, depending on the
# part of speech, place the word into one of three sentence templates
...
# make_sentence(word, part_of_speech) should not return anything, just print the 
# correct sentence with the word filled in the blank.

# Here's a sample run of the program (user input is in blue):

# Please type a noun, verb, or adjective: groovy Is this a noun, verb, or adjective?
# Type 0 for noun, 1 for verb, 2 for adjective: 2 Looking out my window, the sky is
# big and groovy!
...
def main():
    ...
    word =  input("Please type a noun, verb, or adjective: groovy Is this a noun, verb, or adjective? ")
