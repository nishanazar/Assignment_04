...
# to have a precise purpose, sometimes that purpose just deals with multiple bits
# of data.
...
# You can return multiple pieces of data by separating each piece with a comma in
# the return line.
...
# (Note. This idea is called tuple packing/unpacking. We "pack" our return values into a 
# single data structure called a tuple. We can then "unpack" these values back into 
# our original values or leave them as a tuple.)
